...
import { Plus, ArrowLeft, DollarSign, LayoutGrid, Users } from "lucide-react";
    ...
    const fetchUserTools = async () => {
      try {
        ...
        const userToolsWithData = userTools
          ...
          .filter((tool): tool is UserTool => tool !== undefined);
        ...
        setActiveSessions(userTools.length * 2); // Placeholder for active sessions
      } catch (error) {
